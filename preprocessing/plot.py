...
# 1 ————————————————————————————————————————————————————————————————————————
def plot_eog_signals(eog_file: str) -> None:
    """
    ...
    plt.plot(eog_df["time_sec"], eog_df["LOC"], label="LOC", color="blue") # Plot LOC signal
    plt.plot(eog_df["time_sec"], eog_df["ROC"], label="ROC", color="red")  # Plot ROC signal
